...
export const initPayment = () => {
  console.log("heelo mei paykun tkk aaya");
  //   let order = {
  ...
  //       var transaction = pk.getTransactionDetail(
  //         transactionId,
  ...
  //           alert(
  //             "Payment is success, Your transaction ID : " +
  ...
  //           console.log(transaction);
  //           alert(
  //             "Payment is cancelled, Your transaction ID : " +
  //               transaction.transaction.payment_id
  //           );
  //         }
  //       );
